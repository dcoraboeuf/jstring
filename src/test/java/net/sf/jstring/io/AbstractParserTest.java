		...
		Bundle expectedBundle = BundleBuilder.create("sample")
				...
				.section(BundleSectionBuilder.create("default")
						.key(BundleKeyBuilder.create("list.separator.prefix")
                                .value(Locale.ENGLISH, BundleValue.value("- "))
                                .value(Locale.FRENCH, BundleValue.value("- "))
								.build())
				...
				.section(BundleSectionBuilder.create("general")
						...
						.key(BundleKeyBuilder.create("app.title")
								...
								.value(Locale.ENGLISH, BundleValue.value("My favourite application"))
								.value(Locale.FRENCH, BundleValue.value("Mon application préférée"))
								.build())
						.build())
				.section(BundleSectionBuilder.create("home")
						...
						.key(BundleKeyBuilder.create("home.title")
								...
								.value(Locale.ENGLISH, BundleValue.value("Home page"))
								.value(Locale.FRENCH, BundleValue.value("Page d'accueil"))
								.build())
						...
						.key(BundleKeyBuilder.create("home.info")
								...
								.value(Locale.ENGLISH, BundleValue.value("Application version: {version}, build: {build}, {{not a parameter}}"))
                                .value(Locale.FRENCH, BundleValue.value("Version de l'application: {version}, build: {build}, {{pas un paramètre}}"))
								.build())
						.build())
				.build();
